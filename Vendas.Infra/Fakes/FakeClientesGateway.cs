        ...
        private static readonly Dictionary<Guid, Dictionary<Guid, EnderecoDto>> _clientes = new()
        {
            [new Guid("22222222-0000-0000-0000-000000000001")] = new()
            {
                [new Guid("33333333-0000-0000-0000-000000000001")] = new(
                    ...
                    cep: "12345-678", logradouro: "Avenida Paulista", numero: "1000",
                    bairro: "Bela Vista", cidade: "São Paulo", estado: "SP",
                    pais: "Brasil", complemento: "Apto 101"
                ),
                [new Guid("33333333-0000-0000-0000-000000000002")] = new(
                    id: new Guid("33333333-0000-0000-0000-000000000002"),
                    cep: "98765-432", logradouro: "Rua das Flores", numero: "200",
                    bairro: "Jardim", cidade: "Rio de Janeiro", estado: "RJ",
                    pais: "Brasil", complemento: "Casa"
                ),
            },
            [new Guid("22222222-0000-0000-0000-000000000002")] = new()
            {
                [new Guid("33333333-0000-0000-0000-000000000003")] = new(
                    id: new Guid("33333333-0000-0000-0000-000000000003"),
                    cep: "54321-987", logradouro: "Rua dos Pinheiros", numero: "50",
                    bairro: "Pinheiros", cidade: "São Paulo", estado: "SP",
                    pais: "Brasil", complemento: null
                ),
            },
        };
