...
namespace Vendas.Domain.Clientes
{
    public sealed class Cliente : AggregateRoot
    {
        ...
        public void DefinirEnderecoPrincipal(Guid enderecoId)
        {
            ...
            AddDomainEvent(new EnderecoPrincipalAlteradoEvent(ClienteId: Id, NovoEnderecoId: EnderecoPrincipalId));
        ...
        public void AtualizarPerfil(
            ...
            EstadoCivil estadoCivil)
        {
            Guard.Against<DomainException>(Status == StatusCliente.Bloqueado, "Clientes bloqueados não podem atualizar perfil.");
        ...
        public void Bloquear()
        {
            ...
            AddDomainEvent(new ClienteBloqueadoEvent(ClienteId: Id, Cpf: Cpf.Numero));
