...
namespace Vendas.Domain.Clientes.Entities
{
    public sealed class Endereco : Entity
    {
        ...
        public static void Validar(string cep, string logradouro, string numero, string bairro, string cidade, string estado, string pais, string complemento = "")
        {
            ...
            Guard.Against<DomainException>(numero.Length == 0, "Numero inválido");
