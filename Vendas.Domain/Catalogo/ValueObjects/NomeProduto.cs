...
namespace Vendas.Domain.Catalogo.ValueObjects
{
    public sealed class NomeProduto : ValueObject
    {
        ...
        public NomeProduto(string valor)
        {
            ...
            Guard.Against<DomainException>(valor.Length < 3, "O nome do produto deve ter ao menos 3 caracteres.");
            Guard.Against<DomainException>(valor.Length > 150, "O nome do produto deve ter no máximo 150 caracteres.");
