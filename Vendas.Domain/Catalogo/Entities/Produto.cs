...
namespace Vendas.Domain.Catalogo.Entities
{
    public sealed class Produto : AggregateRoot
    {
        ...
        public Produto(NomeProduto nome, CodigoProduto codigo, PrecoProduto preco, Guid categoriaId, int estoqueInicial = 0, string? descricao = null)
        {
            ...
            Guard.Against<DomainException>(estoqueInicial < 0, "Estoque inicial não pode ser negativo.");
        ...
        {
            Guard.Against<DomainException>(Status == StatusProduto.Inativo, "O produto já está inativo.");
        ...
        public void AdicionarImagem(ImagemProduto imagem)
        {
            ...
            Guard.Against<DomainException>(_imagens.Any(i => i.Ordem == imagem.Ordem), "Já existe uma imagem com esta ordem.");
