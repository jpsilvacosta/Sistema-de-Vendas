...
namespace Vendas.Domain.Pedidos.Entities
{
    public sealed class Pedido : AggregateRoot
    {
        ...
        public void AtualizarEnderecoEntrega(EnderecoEntrega novoEndereco)
        {
            ...
            Guard.Against<DomainException>(StatusPedido != StatusPedido.Pendente, "Endereço só pode ser alterado enquanto o pedido está pendente.");
        ...
        public Pagamento IniciarPagamento(MetodoPagamento metodoPagamento)
        {
            ...
            Guard.Against<DomainException>(StatusPedido != StatusPedido.Pendente, "Pagamento só pode ser iniciado a partir do status Pendente.");
        ...
        {
            Guard.Against<DomainException>(StatusPedido != StatusPedido.PagamentoConfirmado, "O pedido só pode ir para 'Em Separação' após o pagamento ser confirmado.");
        ...
        {
            Guard.Against<DomainException>(StatusPedido != StatusPedido.EmSeparacao, "O pedido só pode ser marcado como 'Enviado' se estiver 'Em Separação'.");
        ...
        {
            Guard.Against<DomainException>(StatusPedido != StatusPedido.Enviado, "O pedido só pode ser marcado como 'Entregue' se estiver 'Enviado'.");
